				...
				<tr>
					...
					<td>
						<div class="btn-group" role="group" aria-label="Opciones">
							<a class="btn btn-primary btn-sm" href="libro?id=${libro.id}">Editar</a>
							<a onclick="return confirm('¿Estás seguro?')" class="btn btn-danger btn-sm" href="borrar?id=${libro.id}">Borrar</a>
						</div>
					</td>
				</tr>
			</c:forEach>
